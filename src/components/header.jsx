...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#0A0A0A]/80 backdrop-blur-md py-4 border-b border-white/5">
            ...
            <div className="px-6 py-4 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3 mt-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-[#0A0A0A] bg-[#25D366] rounded-lg hover:bg-[#20bd5a] transition-colors justify-center"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
